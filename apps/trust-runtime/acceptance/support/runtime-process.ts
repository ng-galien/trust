...
import type { RuntimeJsonObject } from "../../src/domain/runtime-model.js";
  ...
  const runtime = spawn(process.execPath, [path.join(buildRoot, "src/index.js")], {
    env: {
      ...
      ...(options.operationsDirectory === undefined
        ? {}
        : { TRUST_EXECUTIONS_DIRECTORY: options.operationsDirectory }),
      ...(options.executionEnvironments === undefined
        ? {}
        : { TRUST_EXECUTION_ENVIRONMENTS_JSON: JSON.stringify(options.executionEnvironments) }),
