...
| **completed · not validated** | l'Opération s'est exécutée, les Facts ont été acceptés, une garde de qualification est fausse — sa raison calculée explique l'observation | traiter la condition observée ; ne pas la réinterpréter comme une progression |
