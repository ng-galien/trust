...
Une <Term id="operation">Opération</Term> dit **comment appeler un système externe** et **quels champs typés cet appel produit**. Elle ne décide pas si un résultat est bon, ne connaît ni les Plans ni les Checks, et ne qualifie jamais. Une Procédure peut donc réutiliser une même Opération dans plusieurs Checks avec des attentes différentes.
