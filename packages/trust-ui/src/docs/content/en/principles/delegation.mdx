...
| **completed · not validated** | the Operation ran, the Facts were accepted, a qualification guard is false — its computed reason explains the observation | address the observed condition; do not reinterpret it as progress |
